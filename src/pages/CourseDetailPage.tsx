            ...
            <div className="prose max-w-none">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-academy-teal mr-2 mt-0.5" />
                  <span>
                    Law students seeking practical knowledge beyond traditional law school
                    curriculum
                  </span>
                </li>
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-academy-teal mr-2 mt-0.5" />
                  <span>
                    Practicing attorneys looking to expand their expertise or transition to a new
                    practice area
                  </span>
                </li>
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-academy-teal mr-2 mt-0.5" />
                  <span>
                    Legal professionals seeking to stay current with evolving legal standards and
                    practices
                  </span>
                </li>
              </ul>
              ...
              <p>
                This {course.level.toLowerCase()} level course is designed for{' '}
                ...
                {course.level !== 'Beginner' &&
                  'Prior experience or coursework in basic legal principles is recommended.'}
              </p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="instructor">
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="md:w-3/4">
                ...
                <div className="prose max-w-none">
                  <p className="mb-4">
                    A distinguished expert in {course.category}, {course.instructor.split(' ')[1]}{' '}
                    brings decades of practical experience and academic expertise to The Ambitious
                    Academy. With a commitment to practical, applicable legal education, they have
                    developed this course to bridge the gap between theoretical knowledge and
                    real-world application.
                  </p>
                  <p>
                    Their teaching philosophy emphasizes critical thinking, ethical practice, and
                    the development of practical skills that can be immediately applied in
                    professional settings. Students consistently praise their ability to explain
                    complex concepts clearly and their dedication to student success.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="space-y-6">
                    <div className="border-b pb-6">
                      ...
                      <p className="text-gray-700">
                        This course exceeded my expectations. The instructor's explanations were
                        clear and the practical examples really helped me apply the concepts in my
                        work. Highly recommended for anyone looking to develop expertise in this
                        area.
                      </p>
                    </div>
                    ...
                    <div className="border-b pb-6">
                      ...
                      <p className="text-gray-700">
                        As a practicing attorney for 10+ years, I was looking to specialize further
                        in this area. The course materials were comprehensive and up-to-date with
                        current legal developments. The instructor's real-world experience added
                        tremendous value.
                      </p>
                    </div>
                  </div>
