              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="linkedin"
                      defaultValue="https://linkedin.com/company/ambitious-academy"
                    />
                  </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Receive notifications when a student enrolls in a course
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Receive notifications when a student leaves a review
                    </p>
                  </div>
                  <div className="flex items-center">
                    <input
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Receive notifications for new blog comments
                    </p>
                  </div>
                  <div className="flex items-center">
                    <input
