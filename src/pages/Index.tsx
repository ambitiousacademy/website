          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg mb-8">
                The Ambitious Academy offers specialized legal education taught by practicing
                attorneys and renowned professors. Develop practical skills and deep knowledge for
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 border border-gray-100 rounded-lg shadow-sm bg-white hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Learn from practicing attorneys and renowned professors with real-world experience.
              </p>
            </div>
            ...
            <div className="text-center p-6 border border-gray-100 rounded-lg shadow-sm bg-white hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Curriculum designed to develop applicable skills for immediate use in legal
                practice.
              </p>
            </div>
            ...
            <div className="text-center p-6 border border-gray-100 rounded-lg shadow-sm bg-white hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Self-paced courses that fit your schedule and professional demands.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Join thousands of legal professionals who have enhanced their practice through The
              Ambitious Academy's specialized courses.
            </p>
