...
async function main() {
    const mentor1 = await prisma_1.default.mentor.findFirst({
        where: {
            name: "Adv. Shashank Mishra",
        }
    });
    const mentor2 = await prisma_1.default.mentor.findFirst({
        where: {
            name: "Adv. Shagufta Rehman"
        }
    });
    await prisma_1.default.course.create({
        data: {
    ...
    await prisma_1.default.course.create({
        data: {
            ...
            description: 'The Real Estate (Regulation and Development) Act, 2016 (RERA) has revolutionized the real estate sector in India, ensuring transparency, accountability, and protection of consumer interests.',
            importance: 'Knowledge of RERA and related legal frameworks has become crucial for professionals, investors, and students in law and business. This course equips learners with a deep understanding of RERA’s legal, regulatory, and compliance aspects.',
            duration: '2 Months',
            classesPerWeek: 3,
            featured: true,
            totalClasses: 25,
