...
async function main() {
    const feedbacks = [
        ...
        },
        {
            ...
            feedbackText: 'I appreciate the ambitious academy for organising insightful series of events. It was truly a valuable opportunity.',
            panelDiscussionRating: 4,
            feedbackFor: 'Extended Event',
            collegeAndCourse: 'Indore Institute of Law',
            timestamp: new Date(),
        },
        {
            ...
            feedbackText: 'The academy arrenged session really very well . All the session were nice and informative.',
            panelDiscussionRating: 5,
            feedbackFor: 'Extended Event',
            collegeAndCourse: 'Indore Institute of Law',
            timestamp: new Date(),
        },
        {
            ...
            feedbackText: 'Well organised sessions and very useful for 1 and 2 year students and also for me to know about the fields of law that whether I choose to go whether in judiciary or in litigation...',
            panelDiscussionRating: 5,
            feedbackFor: 'Extended Event',
            collegeAndCourse: 'Indore Institute of Law',
            timestamp: new Date(),
    ...
    for (const feedback of feedbacks) {
        await prisma_1.default.feedback.create({ data: feedback });
    }
