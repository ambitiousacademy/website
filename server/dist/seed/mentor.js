...
async function main() {
    ...
    const mentorData = [
        {
            ...
            profileSummary: 'Advocate Shashank Mishra is a legal consultant and practicing advocate with over 8 years of professional experience. His practice is result-oriented, focusing on ethical and professional legal consultancy and advisory services.',
            about: 'Advocate Shashank Mishra is a legal consultant and practicing advocate with over 8 years of professional experience. His practice is result-oriented, focusing on ethical and professional legal consultancy and advisory services.',
            featured: true,
            areasOfPractice: [
        ...
        },
        {
            ...
            about: 'Advocate Shagufta Rehman is a legal professional with over 9 years of experience in litigation, legal research, drafting, and corporate legal advisory. She has expertise in problem-solving, document evaluation, legal auditing, and interpretation of laws.',
            featured: true,
            areasOfPractice: [
    ...
    try {
        const result = await prisma_1.default.mentor.createMany({
            data: mentorData,
        });
